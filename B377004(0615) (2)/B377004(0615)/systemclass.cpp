...
bool SystemClass::Initialize()
{
	...
	result = m_Graphics->Initialize(screenWidth, screenHeight, m_hwnd, change);
	if (!result)
	{
		return false;
...
bool SystemClass::Frame()
{
	...
	int KeyNum = m_Input->WhatKeyDown();
	//	Do the frame processing for the graphics object.
	result = m_Graphics->Frame(m_Fps->GetFps(), m_Cpu->GetCpuPercentage(), m_Timer->GetTime(),KeyNum,mouseX,mouseY);
	if (!result)
	{
		return false;
	}
...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	wc.hIconSm = wc.hIcon;
	wc.hCursor = LoadCursor(NULL, IDC_ARROW); wc.hbrBackground = (HBRUSH)GetStockObject(BLACK_BRUSH); wc.lpszMenuName = NULL;
